...
const N_Generation = 4000

let TASK_NUM = tasks.length;
let copyrate = 0.2;
...
function initGA(_taskNum, _nodeNum, _iteratorNum, _chromosomeNum, _cp) {
  for(let i = 0 ; i < _chromosomeNum ; i++){
    ...
    allocation = [2,3,6,5,1, 2,4,5,2,3, 1,3,6,3,5, 2,3,6,5,1, 2,4,5,2,3, 1,3,6,3,5] 
...
function RWS(selectionProbability) {
    // console.log('rws :>> ', selectionProbability);
    let sum = 0;
...
console.log('chromosomeMatrix :>> ',chromosomeMatrix );
console.log('time :>> ', F_time(chromosomeMatrix.pop()));
let xAxis_i = 0;
